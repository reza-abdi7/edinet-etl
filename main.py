...
from src.extract import extract_companies, get_documents_by_date_range, filter_documents, download_documents
...
def main():
    ...
    list_docs = get_documents_by_date_range(start_date=config.start_date_str, end_date=config.end_date_str)
